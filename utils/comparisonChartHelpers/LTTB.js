/**
 * The LTTB (Largest Triangle Three Bucket) is a compression algorithm that focuses on preserving the local extrema.
 * The algorithm compresses the number of data points to the specified threshold amount.
 *
 * Source code (MIT license) can be found here:
