...
const NavBar = () => {
  ...
  return (
    <div className="mt-2 screen-sm:mt-4 mb-4 screen-sm:mb-12">
      <div className="flex max-w-table-xl mx-auto justify-center screen-lg:justify-between mb-1 screen-sm:mb-2">
        <div className="screen-lg:-translate-y-1 fixed z-10 bottom-0 screen-lg:bottom-auto ml-6 screen-xl:mx-0 right-0 screen-lg:right-auto w-full screen-lg:w-auto screen-lg:static screen-lg:block">
          <div className="w-full py-4 backdrop-blur-lg screen-lg:backdrop-blur-none screen-sm:py-8 screen-lg:py-0 screen-lg:w-[520px] screen-lg:rounded-full border-y screen-lg:border-b-0 dark:border-gray-500/50 border-gray-400/50 h-12 flex justify-center items-center gap-x-1 text-zinc-700 dark:text-default font-medium bg-white dark:bg-white/10 shadow-top shadow-menu-highlight/30">
            <NavButtons />
          </div>
        </div>
