...
const NavBar = () => {
  ...
  return (
    <div className="mt-2 screen-sm:mt-4 mb-4 screen-sm:mb-12">
      <div className="flex justify-center screen-lg:justify-between mb-1 screen-sm:mb-2">
        <div className="screen-lg:-translate-y-1 fixed z-10 bottom-0 screen-lg:bottom-auto ml-6 right-0 screen-lg:right-auto w-full screen-lg:w-auto screen-lg:static screen-lg:block">
